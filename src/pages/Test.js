                ...
                {cast.slice(0, 30).map((actor) => (
                    <div key={actor.cast_id} className="actor-card">
                        <img
                            ...
                            onError={(e) => {
                                e.target.onerror = null; // Prevents infinite loop if jj.jpg is also not found
                                e.target.src = 'https://r4.wallpaperflare.com/wallpaper/198/872/888/numbers-404-not-found-simple-background-minimalism-wallpaper-17a93acbb6fa45c5bcfd98b088d7a993.jpg'; // Replace with the actual path to your default image
                            }}
                        />
